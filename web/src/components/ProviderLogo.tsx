...
// verbatim from each icon's source (slugs: claude, openai via jsdelivr).
...
const BRAND: Record<BrandedProvider, BrandMark> = {
  ...
  codex: {
    label: "Codex",
    hex: "currentColor", // OpenAI mark is solid black; use currentColor so it stays visible in dark mode
...
// ProviderLogo renders the provider's brand mark (Claude/Codex) or a
